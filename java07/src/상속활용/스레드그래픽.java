...
public class 스레드그래픽 extends JFrame {
	//class 전체에서 접근해서 사용하려면, 선언을 class 아래에 해서 전역변수로 만들어주어야 한다.
...
//		setBackground(Color.lightGray);
	...
	public static void main(String[] args) {
		//main이 static이기 때문에 static이 없는 생성자 메서드를 활용한다.
		f = new 스레드그래픽();
...
//				System.out.println("카운트: " + i);
			...
			//예외처리
			if (i == 0) {
				JOptionPane.showMessageDialog(f, "사용시간이 만료되었습니다. 퇴실부탁드립니다.");
				image2.stop(); //스레드 멈춤
				day2.stop(); //스레드 멈춤
